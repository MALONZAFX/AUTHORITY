...
ALLOWED_HOSTS = ['privatisation-production.up.railway.app','127.0.0.1','www.privatisation.go.ke','privatisation.go.ke','www.privatisation.go.ke']
CSRF_TRUSTED_ORIGINS=['https://privatisation-production.up.railway.app','https://127.0.0.1','https://privatisation.go.ke','https://www.privatisation.go.ke']
